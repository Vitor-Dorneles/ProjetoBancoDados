...
#
SELECT  Empregado.nome, Empregado.funcao # aqui vamos selecionar da tabela empregado o nome e sua função
FROM  Empregado
WHERE  Empregado.Departamento_idDepartamento > 3; #onde o id departamento é maior que 3
#
SELECT  Empregado.nome, Empregado.funcao
FROM  Empregado  # aqui mostramos os gerentes
...
from Empregado; #aqui ele faz um equals e descarta duplicados
#
############################################################################
...
from Empregado
order by  Empregado.nome; #aqui ele organiza automaticamente em ordemalfabetica
#
select Empregado.nome "Nome do Empregado", Empregado.funcao "Cargo"
from Empregado
order by  Empregado.nome desc; # aqui automaticamente em ordem alfabetica descrescente
#
# Demais Operadores
#
#Operador                  significado
...
FROM  Empregado
WHERE  Empregado.Departamento_idDepartamento  IN  (3,5); #empregados dos departamentos 3 e 5
#
SELECT  Empregado.nome, Empregado.funcao
FROM  Empregado
WHERE   Empregado.nome  LIKE  'L%'; # o like aqui pega quem tem l no nome
#
SELECT Empregado.nome, Empregado.funcao
FROM  Empregado
